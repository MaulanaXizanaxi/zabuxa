...
def tokenz():
    ...
    try:
        ...
        time.sleep(1.7)
        masuk()
        os.system("python2 zabuxa.py")
##### AMBIL LINK #####
def ambil_link():
    os.system("clear")
    print logo
    print 50* "─"
    jalan("anda akan dialihkan ke youtube untuk mengetahui tutornya")
    jalan ("silahkan tonton tutorialnya")
    jalan ("jangan lupa subscribe dan sukai ya")
    os.system('xdg-open https://youtu.be/nH7A_13JaHQ')
